<div class="row justify-content-center">
    <div class="col-md-8">
        <div class="card shadow-sm mb-4 border-bottom-warning">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('user') ?>" class="btn btn-sm btn-warning btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body pb-2">
                ...
                <div class="row form-group justify-content-end">
                    <div class="col-md-8">
                        ...
                        <button type="reset" class="btn btn-warning btn-secondary">Reset</button>
                    </div>
                </div>
                <?= form_close(); ?>
            </div>
