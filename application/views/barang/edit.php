        ...
        <div class="card shadow-sm border-bottom-warning">
            <div class="card-header bg-white py-3">
                <div class="row">
                    ...
                    <div class="col-auto">
                        <a href="<?= base_url('barang') ?>" class="btn btn-sm btn-warning btn-secondary btn-icon-split">
                            <span class="icon">
            ...
            <div class="card-body">
                ...
                <div class="row form-group">
                    <label class="col-md-3 text-md-right" for="kode_barang">Kode Barang</label>
                     <div class="col-md-9">
                        <input value="<?= set_value('nama_satuan', $barang['kode_barang']); ?>" name="kode_barang" id="kode_barang" type="text" class="form-control" placeholder="Kode Barang...">
