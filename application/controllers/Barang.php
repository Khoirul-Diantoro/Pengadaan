...
class Barang extends CI_Controller
{
    ...
    private function _validasi()
    {
        ...
        $this->form_validation->set_rules('type_barang', 'Type Barang', 'required|trim');
        $this->form_validation->set_rules('warna_barang', 'Warna Barang', 'required|trim');
        $this->form_validation->set_rules('ukuran_barang', 'Ukuran Barang', 'required|trim');
        $this->form_validation->set_rules('berat_barang', 'Berat Barang', 'required|trim');
        $this->form_validation->set_rules('merk_barang', 'Merk Barang', 'required|trim');
        $this->form_validation->set_rules('seri_barang', 'Seri Barang', 'required|trim');
    }
