...
class Barang extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('kode_barang', 'Kode Barang', 'required|trim|numeric');
        $this->form_validation->set_rules('nama_barang', 'Nama Barang', 'required|trim');
        $this->form_validation->set_rules('jenis_id', 'Jenis Barang', 'required');
        $this->form_validation->set_rules('nama_satuan', 'Nama Satuan', 'requires|trim');
        $this->form_validation->set_rules('type_barang', 'Type Barang', 'trim|alpha');
        $this->form_validation->set_rules('warna_barang', 'Warna Barang', 'trim|alpha');
        $this->form_validation->set_rules('ukuran_barang', 'Ukuran Barang', 'trim');
        $this->form_validation->set_rules('berat_barang', 'Berat Barang', 'required|trim');
        $this->form_validation->set_rules('merk_barang', 'Merk Barang', 'trim');
        $this->form_validation->set_rules('seri_barang', 'Seri Barang', 'trim');
    }
