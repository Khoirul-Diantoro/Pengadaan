...
class Supplier extends CI_Controller
{
    ...
    {
        $this->form_validation->set_rules('nama_supplier', 'Nama Supplier', 'required|trim|alpha');
        $this->form_validation->set_rules('no_telp', 'Nomor Telepon', 'required|trim|min_length[10]|numeric');
